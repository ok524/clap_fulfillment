                    ...
                    for m in doc.mistakes:
                        ...
                        while wdstart < len(words):
                            ...
                            if nextstart == -1:
                                ...
                                print("Warning in building conll format: can not find word")
                        ...
                        if wdstart == len(words):
                            print('Warning in building conll format: start_off overflow')
                            print(m, sent.sentstr.encode('utf-8'))
                            continue
    ...
    def tokenizeCorrectionStr(self, correctionStr, wdstart, wdend, words):
        ...
        if wdstart != 0:
            ...
            for i in xrange(len(pseudoWordsList)):
                ...
                if s == words[wdstart-1]:
                    ...
                    break
            if start == 0:
                print('Can not find words[wdstart-1]')
        ...
        if wdend != len(words):
            ...
            if end == len(pseudoWordsList):
                print('Can not find words[wdend]')
...
if __name__ == '__main__':
    ...
    for opt, arg in opts:
        if opt == '-g':
            ...
            if arg not in ('1', '0'):
                print('-d option should be 0 or 1')
                sys.exit(2)
            else:
    ...
    if option['-g'] + option['-c'] + option['-l'] + option['-o']  > 1:
        print('only one option among -g, -c, -l, -o is allowed')
        sys.exit(2)
    ...
    if option['-g'] == 1:
        ...
        if os.path.isfile(ppr.docsDumpedFileName) == False:
            print('-c option needs dumped \'docs\' file. Please use -g option first. ')
            sys.exit(2)
